...
class GeneratedAnimation(VoiceoverScene):
    ...
    def intro_scene(self, primary_color, text_color):
        ...
        narration_text_1 = "Hello! Today we will understand Le Chatelier's principle and see what effect increasing pressure has on this chemical equilibrium."
    ...
    def main_content(self, primary_color, secondary_color, accent_color, text_color, warning_color):
        ...
        narration_text_2 = "Here we have a container with reactants and products in equilibrium. Notice that the reactant side has 3 moles of gas, and the product side has 2 moles."
        ...
        narration_text_3 = "Now imagine we double the pressure on this system. When we do this, the container's volume becomes half."
        ...
        narration_text_4 = "When volume decreases, the concentration of each gas increases. Therefore, the concentration of all reactants and products will immediately increase. According to this, Option A is absolutely correct."
        ...
        narration_text_5 = "However, Le Chatelier's principle states that the system will oppose this change. To reduce pressure, equilibrium will shift in the direction where there are fewer gas moles, that is, in the forward direction."
        ...
        self.check_B = Text("✓", font_size=36, color=secondary_color).next_to(options[1], LEFT)
        ...
        narration_text_6 = "One very important point: the equilibrium constant 'K' only changes with temperature, not with pressure. Therefore, options C and D are directly wrong."
    ...
    def conclusion(self, primary_color, secondary_color, text_color):
        ...
        check_A_large = Text("✓", font_size=48, color=secondary_color).next_to(self.options[0], LEFT)
        
        narration_text_7 = "So both A and B are sort of correct, but the first and most direct result of increasing pressure is the increase in concentration. The shift happens afterwards. Therefore, Option A is the most accurate answer."
        ...
        # Outro
        narration_text_8 = "I hope you have understood this concept. Thank you!"
